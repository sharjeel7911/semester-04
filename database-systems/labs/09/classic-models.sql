...
-- Question - 02
SELECT 
    c.customerName, c.addressLine1, c.city, c.country
FROM
    customers c
INNER JOIN
    payments p 
...
-- Question - 04
SELECT 
    CONCAT(e.firstName, ' ', e.lastName), e.jobTitle
FROM
    employees e
INNER JOIN
    offices o 
...
ON
	c.customerNumber = p.customerNumber
WHERE
    p.amount BETWEEN 60000 AND 70000;
-- --------------------------------------------------------------------------------------

-- Question - 06
SELECT 
    CONCAT(e.firstName, ' ',  e.lastName) AS name_of_employee
FROM
    employees e
INNER JOIN
    offices o 
...
-- Question - 08
SELECT 
    c.customerName, o.status, o.comments
FROM
    customers c
INNER JOIN
    orders o 
...
-- Question - 09
SELECT 
    p.productName, pl.textDescription
FROM
    products p
INNER JOIN
    productlines pl 
...
WHERE
    c.contactFirstName LIKE 'A%' AND od.quantityOrdered > 50;
-- --------------------------------------------------------------------------------------